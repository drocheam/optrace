...
# create Raytracer
RT = ot.Raytracer(outline=[-6, 6, -6, 6, -10, 28], absorb_missing=True, no_pol=False)

# add RaySource
RSS = ot.Surface("Circle", r=3)
RS = ot.RaySource(RSS, direction="Parallel", spectrum=ot.presets.light_spectrum.D65, pos=[0, 0, -10])
RT.add(RS)
