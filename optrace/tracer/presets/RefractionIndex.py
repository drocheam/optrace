...
# TODO add plastics from
#    Schwiegerling J. Field Guide to Visual and Ophthalmic Optics. SPIE Publications: 2004., p30
...
Ice: RefractionIndex = RefractionIndex("Data", wls=np.concatenate(([350], 390+10*np.arange(40))),
