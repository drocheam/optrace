...
BAF10: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.5851495, 0.00926681282, 0.143559385,
...
BAK1: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.12365662, 0.00644742752, 0.309276848,
...
BASF64: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.65554268, 0.0104485644, 0.17131977,
...
BK7: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.03961212, 0.00600069867, 0.231792344,
...
F2: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.39757037, 0.00995906143, 0.159201403,
...
FK51A: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[0.971247817, 0.00472301995, 0.216901417,
...
fused_silica: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[0.6961663, 0.0684043**2, 0.4079426,
...
K5: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.08511833, 0.00661099503, 0.199562005,
...
LAF2: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.80984227, 0.0101711622, 0.15729555,
...
LAK8: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.33183167, 0.00620023871, 0.546623206,
...
LAK22: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.14229781, 0.00585778594, 0.535138441,
...
LASF9: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[2.00029547, 0.0121426017, 0.298926886,
...
LASF44: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.78897105, 0.00872506277, 0.38675867,
...
LF5: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.28035628, 0.00929854416, 0.163505973,
...
SF5: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.52481889, 0.011254756, 0.187085527,
...
SF6: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.72448482, 0.0134871947, 0.390104889,
...
SF10: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.62153902, 0.0122241457, 0.256287842,
...
SF11: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.73759695, 0.013188707, 0.313747346,
...
SF66: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[2.0245976, 0.0147053225, 0.470187196,
...
SK14: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[0.936155374, 0.00461716525, 0.594052018,
...
soda_lime: RefractionIndex = RefractionIndex("Function", 
                                             func = lambda wl: 1.5130 - 0.003169*(wl*1e-3)**2 + 0.003962*(wl*1e-3)**-2,
                                             desc="Soda Lime",
                                             long_desc="Clear soda lime silica window glass")
"""Clear soda lime silica window glass"""


SSK8: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.44857867, 0.00869310149, 0.117965926,
...
COC: RefractionIndex = RefractionIndex("Sellmeier2", coeff=[1.045, 0.266, 0.206, 0, 0], desc="COC",
...
PC: RefractionIndex = RefractionIndex(
    "Sellmeier1", coeff=[1.4182, 0.021304, 0, 0, 0, 0], desc="PC", long_desc="Polycarbonate")
"""Polycarbonate, see # https://refractiveindex.info/?shelf=organic&book=polycarbonate&page=Sultanova"""

PDSM: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.0057, 0.013217, 0, 0, 0, 0], desc="PDSM",
...
PMMA: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[0.99654, 0.00787, 0.18964, 0.02191,
                                                             0.00411, 3.85727],
...
PS: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[1.4435, 0.020216, 0, 0, 0, 0],
...
BaF2: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[0.643356, 0.057789**2, 0.506762, 0.10968**2,
                                                             3.8261, 46.3864**2],
...
CaF2: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[0.5675888, 0.050263605**2, 0.4710914,
...
diamond: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[0.3306, 0.1750**2, 4.3356, 0.1060**2, 0, 0],
                                           desc="Diamond", long_desc="Diamond")
"""Diamond, see https://refractiveindex.info/?shelf=main&book=C&page=Peter"""

ethanol: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[0.0165, 9.08, 0.8268, 0.01039, 0, 0],
...
MgF2: RefractionIndex = RefractionIndex("Sellmeier1", coeff=[0.48755108, 0.04338408**2, 0.39875031,
...
water: RefractionIndex = RefractionIndex("Sellmeier3", coeff=[5.684027565E-1, 5.101829712E-3, 1.726177391E-1,
