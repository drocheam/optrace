...
tma = eye.tma()
RT.add(ot.LineMarker(r=8, angle=90, pos=[0, 0, tma.vertex_points[0]], desc="V1"))
RT.add(ot.LineMarker(r=8, angle=90, pos=[0, 0, tma.vertex_points[1]], desc="V2"))
RT.add(ot.LineMarker(r=8, angle=90, pos=[0, 0, tma.principal_points[0]], desc="H1"))
RT.add(ot.LineMarker(r=8, angle=90, pos=[0, 0, tma.principal_points[1]], desc="H2"))
RT.add(ot.LineMarker(r=8, angle=90, pos=[0, 0, tma.nodal_points[0]], desc="N1"))
RT.add(ot.LineMarker(r=8, angle=90, pos=[0, 0, tma.nodal_points[1]], desc="N2"))

# calculate entrance and exit pupil positions from position of eye pupil
en, ex = tma.pupil_position(eye.apertures[0].pos[2])
RT.add(ot.LineMarker(r=8, angle=90, pos=[0, 0, en], desc="EN"))
RT.add(ot.LineMarker(r=8, angle=90, pos=[0, 0, ex], desc="EX"))
