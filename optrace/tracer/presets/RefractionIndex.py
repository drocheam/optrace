...
preset_n_BK7: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.03961212, 0.00600069867, 0.231792344, 
...
preset_n_BAF10: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.5851495, 0.00926681282, 0.143559385, 
...
preset_n_BAK1: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.12365662, 0.00644742752, 0.309276848, 
...
preset_n_BASF64: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.65554268, 0.0104485644, 0.17131977, 
...
preset_n_F2: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.39757037, 0.00995906143, 0.159201403, 
...
preset_n_FK51A: RefractionIndex = RefractionIndex("Sellmeier", coeff=[0.971247817, 0.00472301995, 0.216901417, 
...
preset_n_Fused_Silica: RefractionIndex = RefractionIndex("Sellmeier", coeff=[0.6961663, 0.0684043**2, 0.4079426, 
...
preset_n_K5: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.08511833, 0.00661099503, 0.199562005, 
...
preset_n_LAF2: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.80984227, 0.0101711622, 0.15729555, 
...
preset_n_LAK8: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.33183167, 0.00620023871, 0.546623206, 
...
preset_n_LAK22: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.14229781, 0.00585778594, 0.535138441, 
...
preset_n_LASF9: RefractionIndex = RefractionIndex("Sellmeier", coeff=[2.00029547, 0.0121426017, 0.298926886, 
...
preset_n_LASF44: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.78897105, 0.00872506277, 0.38675867, 
...
preset_n_LF5: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.28035628, 0.00929854416, 0.163505973, 
...
preset_n_SF5: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.52481889, 0.011254756, 0.187085527, 
...
preset_n_SF6: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.72448482, 0.0134871947, 0.390104889, 
...
preset_n_SF10: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.62153902, 0.0122241457, 0.256287842, 
...
preset_n_SF11: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.73759695, 0.013188707, 0.313747346, 
...
preset_n_SF66: RefractionIndex = RefractionIndex("Sellmeier", coeff=[2.0245976, 0.0147053225, 0.470187196, 
...
preset_n_SK14: RefractionIndex = RefractionIndex("Sellmeier", coeff=[0.936155374, 0.00461716525, 0.594052018, 
...
preset_n_Soda_Lime: RefractionIndex = RefractionIndex("Function", 
                                                      func=lambda x: 1.5130-0.003169*(x*1e-3)**2+0.003962*(x*1e-3)**-2,
                                                      desc="Soda Lime", 
...
preset_n_SSK8: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.44857867, 0.00869310149, 0.117965926, 
                                                                     0.0421566593, 1.06937528, 111.300666], 
                                                 desc="SSK8", long_desc="N-SSK8 (SCHOTT)")
"""N-SSK8 (SCHOTT)"""


presets_n_glass: list = [preset_n_BK7, preset_n_BAF10, preset_n_BAK1, preset_n_BASF64, preset_n_F2, preset_n_FK51A,
                         preset_n_Fused_Silica, preset_n_K5, preset_n_LAF2, preset_n_LAK8, preset_n_LAK22, 
                         preset_n_LASF9, preset_n_LASF44, preset_n_LF5, preset_n_SF5, preset_n_SF6, preset_n_SF10, 
                         preset_n_SF11, preset_n_SF66, preset_n_SK14, preset_n_Soda_Lime, preset_n_SSK8]
...
preset_n_CR39: RefractionIndex = RefractionIndex("Conrady", 
                                                 coeff=[1.471862713E+000, 1.520790642E-002, 3.555509148E-005], 
...
preset_n_COC: RefractionIndex = RefractionIndex("Sellmeier", coeff=[2.045-1., 0, 0.266, 0.206**2], desc="COC",
...
preset_n_PC: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.4182, 0.021304], 
                                               desc="PC", long_desc="Polycarbonate")
"""Polycarbonate"""

# https://refractiveindex.info/?shelf=organic&book=polydimethylsiloxane&page=Schneider-RTV615
preset_n_PDSM: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.0057, 0.013217], desc="PDSM", 
...
preset_n_PMMA: RefractionIndex = RefractionIndex("Sellmeier", coeff=[0.99654, 0.00787, 0.18964, 0.02191, 
                                                                     0.00411, 3.85727], 
                                                 desc="PMMA", long_desc="Poly(methyl methacrylate)")
"""Poly(methyl methacrylate)"""

# https://refractiveindex.info/?shelf=3d&book=plastics&page=ps
preset_n_PS: RefractionIndex = RefractionIndex("Sellmeier", coeff=[1.4435, 0.020216], 
...
preset_n_PET: RefractionIndex = RefractionIndex("Data", wls=np.concatenate(([380], 400+10*np.arange(39))),
...
presets_n_plastic: list = [preset_n_CR39, preset_n_COC, preset_n_PC, preset_n_PDSM, preset_n_PET, 
...
preset_n_Air: RefractionIndex = RefractionIndex("Constant", n=1.00027784, desc="Air", 
                                                long_desc="Air at 550nm, 15°C, 1013.25hPa")
"""Air at 550nm, 15°C, 1013.25hPa"""

# https://refractiveindex.info/?shelf=main&book=BaF2&page=Malitson
preset_n_BaF2: RefractionIndex = RefractionIndex("Sellmeier", coeff=[0.643356, 0.057789**2, 0.506762, 0.10968**2, 
                                                                     3.8261, 46.3864**2], 
                                                 desc="BaF2", long_desc="BaF2 (Barium fluoride)")
"""BaF2 (Barium fluoride)"""

# https://refractiveindex.info/?shelf=main&book=CaF2&page=Malitson
preset_n_CaF2: RefractionIndex = RefractionIndex("Sellmeier", coeff=[0.5675888, 0.050263605**2, 0.4710914,
...
preset_n_Diamond: RefractionIndex = RefractionIndex("Sellmeier", coeff=[0.3306, 0.1750**2, 4.3356, 0.1060**2], 
                                                    desc="Diamond", long_desc="Diamond")
"""Diamond"""

# https://refractiveindex.info/?shelf=organic&book=ethanol&page=Sani-formula
preset_n_Ethanol: RefractionIndex = RefractionIndex("Sellmeier", coeff=[0.0165, 9.08, 0.8268, 0.01039], 
...
preset_n_Ice: RefractionIndex = RefractionIndex("Data", wls=np.concatenate(([350], 390+10*np.arange(40))),
                                                vals=[1.3249, 1.3203, 1.3194, 1.3185, 1.3177, 1.3170, 1.3163, 1.3157,
...
preset_n_MgF2: RefractionIndex = RefractionIndex("Sellmeier", coeff=[0.48755108, 0.04338408**2, 0.39875031, 
                                                                     0.09461442**2, 2.3120353, 23.793604**2], 
                                                 desc="MgF2", long_desc="MgF2 (Magnesium fluoride)")
"""MgF2 (Magnesium fluoride)"""

preset_n_Vacuum: RefractionIndex = RefractionIndex("Constant", n=1.0, desc="Vacuum", long_desc="Vacuum")
"""Vacuum"""

# https://refractiveindex.info/?shelf=main&book=H2O&page=Daimon-20.0C
preset_n_Water: RefractionIndex = RefractionIndex("Sellmeier", coeff=[5.684027565E-1, 5.101829712E-3, 1.726177391E-1, 
...
presets_n_misc: list = [preset_n_Air, preset_n_BaF2, preset_n_CaF2, preset_n_Ethanol, preset_n_Diamond, preset_n_Ice, 
...
presets_n: list = [*presets_n_glass, *presets_n_plastic, *presets_n_misc]
